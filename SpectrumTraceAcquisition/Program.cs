...
namespace SpectrumTraceAcquisition
{
	class Program
	{
		...
		public static SpectrumDetectors DetectorTypeShortName2Enum(string detectorTypeShortName)
		{
			...
			{
				case "AVERAGE":
					return SpectrumDetectors.SpectrumDetector_AverageVRMS;
				case "NEGPEAK":
					return SpectrumDetectors.SpectrumDetector_NegPeak;
				case "PEAK":
					return SpectrumDetectors.SpectrumDetector_PosPeak;
				case "SAMPLE":
					return SpectrumDetectors.SpectrumDetector_Sample;
				default:
					return SpectrumDetectors.SpectrumDetector_PosPeak;
			}
		}
